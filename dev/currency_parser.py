...
# Partial test at https://regex101.com/r/KFaYjq/2
...
pattern = (r'^(?:(?P<currency>\p{Sc}|'
           r'(?P<currency>'
            ...
            r'J(?:EP|MD|OD|PY)|K(?:[GE]S|HR|MF|[PR]W|[WY]D|ZT)|L(?:AK|BP|KR|[RY]D|SL)|'
            r'M(?:[AK]D|DL|GA|[MW]K|NT|OP|RO|[UVY]R|[XZ]N)|N(?:[AZ]D|GN|IO|OK|PR)|(?:QA|OM)R|'
            r'P(?:AB|[EKL]N|GK|HP|KR|YG)|R(?:ON|SD|UB|WF)|S(?:AR|[BRGDT]D|CR|DG|EK|[HY]P|[LZ]L|OS|PL|VC)|'
